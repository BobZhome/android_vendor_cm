...
JELLY_BEER_VERSION_MINOR := 1
JELLY_BEER_VERSION_MAINTENANCE := 7
JELLY_BEER_VERSION := $(JELLY_BEER_VERSION_MAJOR).$(JELLY_BEER_VERSION_MINOR)$(JELLY_BEER_VERSION_MAINTENANCE)-$(shell date +%0d%^b%Y-%H%M%S)
